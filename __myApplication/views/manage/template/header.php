...
<head>
    ...
    <link href="<?php echo asset_url(); ?>css/manage/manageStyle.css" rel="stylesheet" type="text/css">
    ...
    <script src="<?php echo asset_url(); ?>js/manage/custom.js"></script>
    <script src="<?php echo asset_url(); ?>js/js-persian-cal.min.js"></script>
    <script src="<?php echo asset_url(); ?>js/jquery.animate-colors-min.js"></script>
...
<!--    <script src="--><?php //echo asset_url(); ?><!--js/jquery.slimscroll.min.js"></script>-->
    ...
    <title>انجمن اهدای عضو ایرانیان | مدیریت</title>
</head>
<body>
