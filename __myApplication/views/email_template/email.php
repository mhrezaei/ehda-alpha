                                                    ...
                                                    <tbody><tr>
                                                        <td style="border-collapse:collapse;color:#525252;padding:0px!important;text-align:justify;direction:rtl;font-family:Tahoma;line-height:20px;font-size:8pt" align="right" valign="top"> <br>
                                                            <div style="font-size:15px;color:rgb(83,83,83);text-align:justify;font-weight:bold;font-family:Tahoma">
                                                                ...
                                                                بازآوری رمز عبور سامانه www.ehda.center

                                                            </div>
                                                            <br>

                                                            شما در خواست بازآوری رمز عبور را به این سامانه ارسال کرده اید، جهت بازآوری رمز عبور
                                                            <a href="<?php echo base_url('users/forgotPassword/' . $auth) ?>">اینجا</a>
                                                             کلیک نمائید.
                                                            <br>
                                                            همچنین می توانید آدرس زیر را در مرورگر خود باز نمائید:
                                                            <br>
                                                            <a href="<?php echo base_url('users/forgotPassword/' . $auth) ?>"><?php echo base_url('users/forgotPassword/' . $auth) ?></a>

                                                            <br>
                                                            <br>
                                                            <strong>توجه: درصورتی که این درخواست توسط شما ارسال نشده است، این ایمیل را نادیده بگیرید.</strong>

                                                            <br>
                                                            باتشکر
                                                            <br>
                                                            <a href="<?php echo base_url(); ?>">www.ehda.center</a>
                                            ...
                                            <td align="center" valign="top" height="10" style="border-collapse:collapse;color:#525252"></td>
                                                ...
                                                <table width="100%" valign="top" border="0" cellpadding="0" cellspacing="0" dir="rtl"> <tbody><tr>
                                                        ...
                                                        <td width="100%" style="font-size:8pt;border-collapse:collapse;color:#525252;padding:10px;background-color:rgb(255,255,255);border-color:#e8e8e8;border-width:1px;border-radius:5px;border-style:solid;font-size:8pt;padding:15px 40px!important" align="left" valign="top"> <center>
                                                                ...
                                                                &nbsp; |&nbsp;&nbsp;
                                                                <a href="<?php echo base_url('#کارت_اهدای_عضو'); ?>" style="color:#999;text-decoration:none;font-family:Tahoma;font-size:8pt" target="_blank">کارت اهدای عضو</a>
                                                                &nbsp; |&nbsp;&nbsp;
                                                                <a href="<?php echo base_url('#درباره_ما'); ?>" style="color:#999;text-decoration:none;font-family:Tahoma;font-size:8pt" target="_blank">درباره ما</a>
                                                                &nbsp; |&nbsp;
                                                                <a href="<?php echo base_url('#تماس_با_ما'); ?>" style="color:#999;text-decoration:none;font-family:Tahoma;font-size:8pt" target="_blank">تماس باما</a>
                                                            </center>
                                                        </td>
                                                    </tr>
                                                    </tbody>
