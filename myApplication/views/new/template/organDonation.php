<title><?php echo $site_title_fa; ?> | کارت اهدای عضو</title>
        ...
        <div class="container">
            <div class="col-12" id="ehdaCardContent">
                <div class="row ehdaCardP" style="font-family: 'IRANSans', 'Tahoma'; font-style: normal; font-size: 15px;">
                    ...
                    <div class="col-8" style="padding-top: 10px; color: #201b63;">
                        ...
                        <br />
                        1- عزیزانی که برای دریافت کارت اهدای عضو از طریق سامانه ehda.ir ثبت نام کرده اند، توجه داشته باشند که جهت پیگیری کارت خود لازم است به همان سامانه مراجعه کنند و یا جهت ثبت اطلاعات خود در سامانه ehda.center که سامانه مرکزی کارت اهدای عضو بوده و اطلاعات داوطلبان در سامانه وزارت بهداشت، درمان و آموزش پزشکی ثبت شده و از طریق واحدهای اهدای عضو کل کشور قابل دسترس می باشد، نیز اقدام نمایند.
                        <br />
                        2- در صورتیکه علاوه بر ثبت اطلاعات تان در سامانه مرکزی اهدای عضو تمایل دارید کارت اهدای عضو را نیز دریافت نمائید، می توانید کارت موقت خود را بلافاصله پس از تکمیل اطلاعات پرینت گرفته و يا منتظر کارت نهایی خود با طرح جدید کشوری که بزودی ارائه می گردد،باشید.
            ...
            <!-- login form -->
            <div class="col-12 borderRadius" id="loginForm" style="display: none; margin-bottom: 50px; background-color: #e0d6c8; margin-top: 25px;">
                <h4 style="text-align: center; color: #5e3d10;">ورود به سامانه</h4>
                <div class="ehdaCardP">
                <form class="form-horizontal" name="loginForm">
                    <div class="form-group has-feedback">
                        <label for="txtLoginUsername">نام کاربری:</label>
                    ...
                    <div class="form-group has-feedback">
                        <label for="txtLoginPassword">رمز عبور:</label>
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <label for="txtLoginQa" id="qaLabel">حاصل <?php echo $userLoginQs['value']; ?>؟</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-4" style="text-align: left; padding-top: 12px;" id="loginBtns">
            ...
            <div class="col-12" style="text-align: left; margin-top: 30px; padding-left: 30px;" id="loginRegisterBtn">
                <?php if($this->users_model->is_user()){ ?>
                    <button class="btn btn-primary" style="font-family: webYekan;" onclick="changeUrl('users')">پروفایل شخصی</button>
                <?php }else{ ?>
                    <a href="<?php echo site_url('home/register'); ?>" class="btn btn-success" style="font-family: 'webYekan', Tahoma">ثبت نام کارت اهدای عضو</a>
