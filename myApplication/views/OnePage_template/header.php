...
<head>
    ...
    <link href="<?php echo asset_url(); ?>css/jquery.fullPage.css" rel="stylesheet" type="text/css">
...
<!--    <script src="--><?php //echo asset_url(); ?><!--js/ui/jquery-ui.min.js"></script>-->
    <script src="<?php echo asset_url(); ?>js/jquery.fullPage.min.js"></script>
    <script src="<?php echo asset_url(); ?>js/jquery.slimscroll.min.js"></script>
    <script src="<?php echo asset_url(); ?>js/states.js"></script>
    <script>
        function base_url()
        {
    ...
    <title>اهدای عضو، اهدای زندگی | وزارت بهداشت، درمان و آموزش پزشکی | اداره پیوند و بیماری های خاص | انجمن اهدای عضو ایرانیان</title>
</head>
<body>
