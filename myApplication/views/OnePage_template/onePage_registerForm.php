        ...
        <div class="panel-body">
            <form class="form-horizontal" name="registerForm" id="registerForm">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="txtRegisterFirstName" name="txtRegisterFirstName" data-toggle="tooltip" data-placement="left" title="مثال: محمد" placeholder="نام خود را با حروف فارسی وارد نمائید">
                    </div>
                    <div class="col-sm-1">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="txtRegisterLastName" name="txtRegisterLastName" placeholder="نام خانوادگی خود را با حروف فارسی وارد نمائید">
                    </div>
                    <div class="col-sm-1">
                        <span class="glyphicon glyphicon-star formRequired" title="تکمیل الزامی" style="display: block;"></span>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="txtRegisterIDNumber" name="txtRegisterIDNumber" placeholder="شماره شناسنامه خود را به صورت عددی وارد نمائید">
                    </div>
                    <div class="col-sm-1">
                        <span class="glyphicon glyphicon-star formRequired" title="تکمیل الزامی" style="display: block;"></span>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="txtRegisterNationalCode" name="txtRegisterNationalCode" maxlength="10" placeholder="کد ملی خود را ده رقمی و بدون خط تیره وارد نمائید">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="txtRegisterPlaceOfBirth" name="txtRegisterPlaceOfBirth" placeholder="محل تولد خود را با حروف فارسی وارد نمائید">
                    </div>
                    <div class="col-sm-1">
                        <span class="glyphicon glyphicon-star formRequired" title="تکمیل الزامی" style="display: block;"></span>
                    </div>
...
<!--                            <button aria-label="Close" data-dismiss="alert" class="close" type="button"><span aria-hidden="true">×</span></button>-->
                    ...
                    <div class="col-sm-4" style="text-align: left; padding-top: 12px;">
                        <div id="divBtn" style="width: 100%;">
                            <button type="button" class="btn btn-warning" style="float: left;" onclick="window.location = '<?php echo site_url('#organ_donate_card'); ?>'">انصراف</button>
