                    ...
                    <div class="col-lg-12">
                        ...
                        <form method="post" name="addNewsForm">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="txtTitle" name="txtTitle" placeholder="تیتر خبر">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control txtDate" id="txtDate" name="txtDate" placeholder="تاریخ خبر">
                                <input type="hidden" id="txtExtraDate" name="txtExtraDate">
                                <script>
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <textarea class="form-control" id="txtContent" name="txtContent" rows="10" cols="80"></textarea>
                            </div>
